...
}):this.find("a,area").filter(_2).bind(a.event,function(e){
_1(e,this,a);
}).end().end();
function _2(){
...
function _1(e,a,b){
var c=a.hash.slice(1),_3=document.getElementById(c)||document.getElementsByName(c)[0];
if(!_3){
return;
}
if(e){
...
var d=$(b.target);
if(b.lock&&d.is(":animated")||b.onBefore&&b.onBefore(e,_3,d)===false){
return;
}
if(b.stop){
...
if(b.hash){
var f=_3.id===c?"id":"name",$a=$("<a> </a>").attr(f,c).css({position:"absolute",top:$(window).scrollTop(),left:$(window).scrollLeft()});
_3[f]="";
$("body").prepend($a);
...
d.scrollTo(_3,b).trigger("notify.serialScroll",[_3]);
};
return h;
}));
...
function _1(){
var _2=this;
_2.defaults={hideMode:"fadeToggle",defaultSearchMode:"parent",defaultTarget:".content",throwOnMissingTarget:true,keepStateInCookie:false,cookieName:"simple-expand"};
_2.settings={};
$.extend(_2.settings,_2.defaults);
_2.findLevelOneDeep=function(_3,_4,_5){
return _3.find(_4).filter(function(){
return !$(this).parentsUntil(_3,_5).length;
});
};
_2.setInitialState=function(_6,_7){
var _8=_2.readState(_6);
if(_8){
_6.removeClass("collapsed").addClass("expanded");
_2.show(_7);
}else{
_6.removeClass("expanded").addClass("collapsed");
_2.hide(_7);
}
};
_2.hide=function(_9){
if(_2.settings.hideMode==="fadeToggle"){
_9.hide();
}else{
if(_2.settings.hideMode==="basic"){
_9.hide();
}
}
};
...
_2.checkKeepStateInCookiePreconditions=function(){
if(_2.settings.keepStateInCookie&&$.cookie===undefined){
throw new Error("simple-expand: keepStateInCookie option requires $.cookie to be defined.");
}
};
_2.readCookie=function(){
var _b=$.cookie(_2.settings.cookieName);
if(_b===null||_b===""){
return {};
}else{
...
_2.readState=function(_c){
if(!_2.settings.keepStateInCookie){
return _c.hasClass("expanded");
}
var id=_c.attr("Id");
if(id===undefined){
return;
}
var _d=_2.readCookie();
var _e=_d[id];
...
var _11=_2.readCookie();
_11[id]=_10;
$.cookie(_2.settings.cookieName,JSON.stringify(_11),{raw:true,path:window.location.pathname});
};
_2.toggle=function(_12,_13){
var _14=_2.toggleCss(_12);
if(_2.settings.hideMode==="fadeToggle"){
_13.fadeToggle(150);
}else{
if(_2.settings.hideMode==="basic"){
...
if($.isFunction(_2.settings.hideMode)){
_2.settings.hideMode(_12,_13,_14);
}
}
}
_2.saveState(_12,_14);
return false;
};
_2.toggleCss=function(_15){
if(_15.hasClass("expanded")){
_15.toggleClass("collapsed expanded");
return false;
}else{
_15.toggleClass("expanded collapsed");
return true;
}
};
_2.findTargets=function(_16,_17,_18){
var _19=[];
if(_17==="absolute"){
_19=$(_18);
}else{
if(_17==="relative"){
_19=_2.findLevelOneDeep(_16,_18,_18);
}else{
if(_17==="parent"){
var _1a=_16.parent();
do{
_19=_2.findLevelOneDeep(_1a,_18,_18);
if(_19.length===0){
_1a=_1a.parent();
}
}while(_19.length===0&&_1a.length!==0);
}
}
}
return _19;
};
_2.activate=function(_1b,_1c){
$.extend(_2.settings,_1c);
_2.checkKeepStateInCookiePreconditions();
_1b.each(function(){
var _1d=$(this);
var _1e=_1d.attr("data-expander-target")||_2.settings.defaultTarget;
var _1f=_1d.attr("data-expander-target-search")||_2.settings.defaultSearchMode;
var _20=_2.findTargets(_1d,_1f,_1e);
if(_20.length===0){
if(_2.settings.throwOnMissingTarget){
throw "simple-expand: Targets not found";
}
return this;
}
_2.setInitialState(_1d,_20);
_1d.click(function(){
return _2.toggle(_1d,_20);
});
});
};
};
window.SimpleExpand=_1;
$.fn.simpleexpand=function(_21){
var _22=new _1;
_22.activate(this,_21);
return this;
};
})(jQuery);
...
_4.prototype={defaults:{navItems:"a",currentClass:"current",changeHash:false,easing:"swing",filter:"",scrollSpeed:750,scrollThreshold:0.5,begin:false,end:false,scrollChange:false},init:function(){
...
return this;
},adjustNav:function(_7,_8){
_7.$elem.find("."+_7.config.currentClass).removeClass(_7.config.currentClass);
_8.addClass(_7.config.currentClass);
},bindInterval:function(){
var _9=this;
var _a;
_9.$win.on("scroll.onePageNav",function(){
_9.didScroll=true;
});
_9.t=setInterval(function(){
_a=_9.$doc.height();
if(_9.didScroll){
_9.didScroll=false;
_9.scrollChange();
...
return _b.attr("href").split("#")[1];
},getPositions:function(){
var _c=this;
var _d;
var _e;
var _f;
_c.$nav.each(function(){
_d=_c.getHash($(this));
_f=$("#"+_d);
if(_f.length){
_e=_f.offset().top;
_c.sections[_d]=Math.round(_e);
}
});
},getSection:function(_10){
var _11=null;
var _12=Math.round(this.$win.height()*this.config.scrollThreshold);
for(var _13 in this.sections){
if((this.sections[_13]-_12)<_10){
_11=_13;
}
}
return _11;
...
var _14=this;
var _15=$(e.currentTarget);
var _16=_15.parent();
var _17="#"+_14.getHash(_15);
if(!_16.hasClass(_14.config.currentClass)){
if(_14.config.begin){
_14.config.begin();
}
_14.adjustNav(_14,_16);
_14.unbindInterval();
_14.scrollTo(_17,function(){
if(_14.config.changeHash){
_1.location.hash=_17;
}
_14.bindInterval();
if(_14.config.end){
_14.config.end();
...
var _18=this.$win.scrollTop();
var _19=this.getSection(_18);
var _1a;
if(_19!==null){
_1a=this.$elem.find("a[href$=\"#"+_19+"\"]").parent();
if(!_1a.hasClass(this.config.currentClass)){
this.adjustNav(this,_1a);
if(this.config.scrollChange){
this.config.scrollChange(_1a);
}
}
}
},scrollTo:function(_1b,_1c){
var _1d=$(_1b).offset().top;
$("html, body").animate({scrollTop:_1d},this.config.scrollSpeed,this.config.easing,_1c);
},unbindInterval:function(){
clearInterval(this.t);
this.$win.unbind("scroll.onePageNav");
}};
_4.defaults=_4.prototype.defaults;
$.fn.onePageNav=function(_1e){
return this.each(function(){
new _4(this,_1e).init();
});
};
})(jQuery,window,document);
...
"use strict";
var _1=(window.styleMedia||window.media);
if(!_1){
var _2=document.createElement("style"),_3=document.getElementsByTagName("script")[0],_4=null;
_2.type="text/css";
_2.id="matchmediajs-test";
_3.parentNode.insertBefore(_2,_3);
_4=("getComputedStyle" in window)&&window.getComputedStyle(_2,null)||_2.currentStyle;
_1={matchMedium:function(_5){
var _6="@media "+_5+"{ #matchmediajs-test { width: 1px; } }";
if(_2.styleSheet){
_2.styleSheet.cssText=_6;
}else{
_2.textContent=_6;
}
return _4.width==="1px";
...
return function(_7){
return {matches:_1.matchMedium(_7||"all"),media:_7||"all"};
};
}());

(function($){
"use strict";
$.ajaxChimp={responses:{"We have sent you a confirmation email":0,"Please enter a value":1,"An email address must contain a single @":2,"The domain portion of the email address is invalid (the portion after the @: )":3,"The username portion of the email address is invalid (the portion before the @: )":4,"This email address looks fake or invalid. Please enter a real email address":5},translations:{en:null},init:function(_1,_2){
$(_1).ajaxChimp(_2);
}};
$.fn.ajaxChimp=function(_3){
$(this).each(function(i,_4){
var _5=$(_4);
var _6=_5.find("input[type=email]");
var _7=_5.find("label[for="+_6.attr("id")+"]");
var _8=$.extend({url:_5.attr("action"),language:"en"},_3);
var _9=_8.url.replace("/post?","/post-json?").concat("&c=?");
_5.attr("novalidate","true");
_6.attr("name","EMAIL");
_5.submit(function(){
function _a(_b){
if(_b.result==="success"){
_c="We have sent you a confirmation email";
_7.removeClass("error").addClass("valid");
_6.removeClass("error").addClass("valid");
}else{
_6.removeClass("valid").addClass("error");
_7.removeClass("valid").addClass("error");
var _d=-1;
var _c;
try{
var _e=_b.msg.split(" - ",2);
if(_e[1]===undefined){
_c=_b.msg;
}else{
var i=parseInt(_e[0],10);
if(i.toString()===_e[0]){
_d=_e[0];
_c=_e[1];
}else{
...
if(_8.language!=="en"&&$.ajaxChimp.responses[_c]&&$.ajaxChimp.translations&&$.ajaxChimp.translations[_8.language]&&$.ajaxChimp.translations[_8.language][$.ajaxChimp.responses[_c]]){
_c=$.ajaxChimp.translations[_8.language][$.ajaxChimp.responses[_c]];
}
_7.html(_c);
_7.show(2000);
if(_8.callback){
...
var _f={};
var _10=_5.serializeArray();
$.each(_10,function(_11,_12){
_f[_12.name]=_12.value;
});
$.ajax({url:_9,data:_f,success:_a,dataType:"jsonp",error:function(_13,_14){
console.log("mailchimp ajax submit error: "+_14);
}});
var _15="Submitting...";
if(_8.language!=="en"&&$.ajaxChimp.translations&&$.ajaxChimp.translations[_8.language]&&$.ajaxChimp.translations[_8.language]["submit"]){
_15=$.ajaxChimp.translations[_8.language]["submit"];
}
_7.html(_15).show(2000);
return false;
});
});
return this;
...
(function($){
"use strict";
$.fn.fitVids=function(_1){
var _2={customSelector:null,ignore:null,};
if(!document.getElementById("fit-vids-style")){
var _3=document.head||document.getElementsByTagName("head")[0];
var _4=".fluid-width-video-wrapper{width:100%;position:relative;padding:0;}.fluid-width-video-wrapper iframe,.fluid-width-video-wrapper object,.fluid-width-video-wrapper embed {position:absolute;top:0;left:0;width:100%;height:100%;}";
var _5=document.createElement("div");
_5.innerHTML="<p>x</p><style id=\"fit-vids-style\">"+_4+"</style>";
_3.appendChild(_5.childNodes[1]);
}
if(_1){
$.extend(_2,_1);
}
return this.each(function(){
var _6=["iframe[src*='player.vimeo.com']","iframe[src*='youtube.com']","iframe[src*='youtube-nocookie.com']","iframe[src*='kickstarter.com'][src*='video.html']","object","embed"];
if(_2.customSelector){
_6.push(_2.customSelector);
}
var _7=".fitvidsignore";
if(_2.ignore){
_7=_7+", "+_2.ignore;
}
var _8=$(this).find(_6.join(","));
_8=_8.not("object object");
_8=_8.not(_7);
_8.each(function(){
var _9=$(this);
if(_9.parents(_7).length>0){
return;
}
if(this.tagName.toLowerCase()==="embed"&&_9.parent("object").length||_9.parent(".fluid-width-video-wrapper").length){
return;
}
if((!_9.css("height")&&!_9.css("width"))&&(isNaN(_9.attr("height"))||isNaN(_9.attr("width")))){
_9.attr("height",9);
_9.attr("width",16);
}
var _a=(this.tagName.toLowerCase()==="object"||(_9.attr("height")&&!isNaN(parseInt(_9.attr("height"),10))))?parseInt(_9.attr("height"),10):_9.height(),_b=!isNaN(parseInt(_9.attr("width"),10))?parseInt(_9.attr("width"),10):_9.width(),_c=_a/_b;
if(!_9.attr("id")){
var _d="fitvid"+Math.floor(Math.random()*999999);
_9.attr("id",_d);
}
_9.wrap("<div class=\"fluid-width-video-wrapper\"></div>").parent(".fluid-width-video-wrapper").css("padding-top",(_c*100)+"%");
_9.removeAttr("height").removeAttr("width");
});
});
};
...
function mailchimpCallback(_1){
if(_1.result==="success"){
$(".subscription-success").html("<i class=\"icon_check_alt2\"></i><br/>"+_1.msg).fadeIn(1000);
$(".subscription-error").fadeOut(500);
}else{
if(_1.result==="error"){
$(".subscription-error").html("<i class=\"icon_close_alt2\"></i><br/>"+_1.msg).fadeIn(1000);
}
}
};
...
function mainNav(){
var _2=(document.documentElement&&document.documentElement.scrollTop)||document.body.scrollTop;
if(_2>40){
...
function mainNav(){
var _3=(document.documentElement&&document.documentElement.scrollTop)||document.body.scrollTop;
if(_3>40){
$(".sticky-navigation").stop().animate({"top":"0"});
}else{
...
var _4=$(window).height();
$(".full-screen").css("min-height",_4);
};
$(document).ready(function(){
alturaMaxima();
...
$("a.scrollto").bind("click.smoothscroll",function(_5){
_5.preventDefault();
var _6=this.hash;
$("html, body").stop().animate({"scrollTop":$(_6).offset().top},scrollAnimationTime,scrollAnimation,function(){
window.location.hash=_6;
});
});
...
var _7=$("#screenshots");
_7.owlCarousel({items:4,itemsDesktop:[1000,4],itemsDesktopSmall:[900,2],itemsTablet:[600,1],itemsMobile:false});
});
$(document).ready(function(){
...
e.preventDefault();
var _8=$("#subscriber-email").val();
var _9="email="+_8;
function _a(_b){
var _c=new RegExp(/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i);
return _c.test(_b);
};
if(_a(_8)){
$.ajax({type:"POST",url:"subscribe/subscribe.php",data:_9,success:function(){
...
var _f=$("#subject").val();
var _10=$("#message").val();
var _11="name="+_d+"&email="+_e+"&subject="+_f+"&message="+_10;
function _12(_13){
var _14=new RegExp(/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i);
return _14.test(_13);
};
if(_12(_e)&&(_10.length>1)&&(_d.length>1)){
$.ajax({type:"POST",url:"sendmail.php",data:_11,success:function(){
$(".success").fadeIn(1000);
$(".error").fadeOut(500);
}});
}else{
